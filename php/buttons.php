...
<header class="header">
    ...
    <span class="left-slider">
                ...
                <a href="buttons.php" class="sidebar-btn" style="padding-top: 25px;padding-bottom: 25px;border-radius: 50px;transform: scale(1.1);box-shadow: 0 0 30px rgba(255, 255, 255, 0.9);">Buttons</a>
...
<body>
<div class="b_head">
<h1 class="b_headtext">Buttons </h1>
    <h2 class="b_b_headtext">Open-Source buttons made with HTML and CSS </h2>
</div>
        ...
        <table>
            <tr>
                <td>
                    ...
                    <textarea class="html_code" name="html_code" id="html_code" cols="500">
                ...
                <td>
                    ...
                    <textarea class="css_code" name="css_code" id="css_code" cols="500" >
          ...
          <circle cx="5.73583" cy="17.3868" r="1.5" fill="black"></circle>
            ...
            <article class="square">
                ...
                <div class="button_me">
                    ...
                    <div class="button-container">
                        <button class="brutalist_1-button_1 openai">
            ...
            <article class="square">
                <div class="button_me">
                    ...
                    <button class="button_7" data-text="Awesome">
                        <span class="actual-text">&nbsp;PixelSyntax&nbsp;</span>
                        <span aria-hidden="true" class="hover-text">&nbsp;PixelSyntax&nbsp;</span>
                    </button>
                </div>
                <div class="card">
                    <button class="copy_1">Next</button>
